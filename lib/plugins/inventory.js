...
function inject (bot, { version, hideErrors }) {
  ...
  async function activateBlock (block, direction = 1, cursorPos = new Vec3(0.5, 0.5, 0.5)) {
  ...
  bot.activateBlock = callbackifyWithOptionalArguments(activateBlock)
  ...
  bot.openBlock = callbackifyWithOptionalArguments(openBlock)
